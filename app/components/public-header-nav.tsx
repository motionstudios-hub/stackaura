...
export default function PublicHeaderNav({
  ...
  return (
    <nav className={cn("hidden lg:flex", className)}>
      <div
        ref={containerRef}
        className="relative flex items-center gap-2 rounded-full border border-white/38 bg-white/16 p-1.5 shadow-[0_12px_28px_rgba(133,156,180,0.10)] backdrop-blur-2xl"
